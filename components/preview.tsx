...
export function Preview({
  ...
  return (
    <div className="absolute md:relative z-10 top-0 left-0 shadow-xl md:rounded-tl-2xl md:rounded-bl-2xl md:border-l md:border-y bg-background h-[70vh] md:h-full w-full overflow-auto">
      <Tabs
        value={selectedTab}
        onValueChange={(value) =>
